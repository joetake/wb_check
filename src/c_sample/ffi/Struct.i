...
{
    if (__builtin_expect(((off | len | (off + len) | (mem->size - (off + len))) < 0), 0)) {
...
{
    if (__builtin_expect(((mem->flags & 0x01) == 0), 0)) {
        rbffi_AbstractMemory_Error(mem, 0x01);
    }
}
static inline void
checkWrite(AbstractMemory* mem)
{
    if (__builtin_expect(((mem->flags & 0x02) == 0), 0)) {
        rbffi_AbstractMemory_Error(mem, 0x02);
    }
}
...
typedef struct Pointer {
    ...
    extern VALUE rbffi_MemoryPointer_NewInstance(long size, long count, _Bool clear);
...
ClosurePool* rbffi_ClosurePool_New(int closureSize,
        _Bool (*prep)(void* ctx, void *code, Closure* closure, char* errbuf, size_t errbufsize),
        void* ctx);
...
const rb_data_type_t rbffi_struct_data_type = {
...
VALUE rbffi_StructClass = ((VALUE)RUBY_Qnil);
VALUE rbffi_StructInlineArrayClass = ((VALUE)RUBY_Qnil);
VALUE rbffi_StructLayoutCharArrayClass = ((VALUE)RUBY_Qnil);
...
{
    AbstractMemory *mem;
    ((mem) = ((AbstractMemory *)rb_check_typeddata((self), (&rbffi_abstract_memory_data_type))));
    return mem->address;
}
static VALUE
...
{
    Struct* s;
    VALUE obj = __extension__({ VALUE data_struct_obj = rb_data_typed_object_zalloc(klass, sizeof(Struct), &rbffi_struct_data_type); (s) = (Struct *)RTYPEDDATA_GET_DATA(data_struct_obj); ((void)(s)); data_struct_obj; });
    (rb_obj_write((VALUE)(obj), (VALUE *)(&s->rbPointer), (VALUE)(((VALUE)RUBY_Qnil)), "Struct.c", 110));
    (rb_obj_write((VALUE)(obj), (VALUE *)(&s->rbLayout), (VALUE)(((VALUE)RUBY_Qnil)), "Struct.c", 111));
    return obj;
}
static VALUE
...
{
    Struct* s;
    VALUE rbPointer = ((VALUE)RUBY_Qnil), rest = ((VALUE)RUBY_Qnil), klass = rb_class_of(self);
    int nargs;
    ((s) = ((Struct *)rb_check_typeddata((self), (&rbffi_struct_data_type))));
    nargs = rb_scan_args(argc, argv, "01*", &rbPointer, &rest);
    if (nargs > 1) {
        VALUE rbLayout = rb_apply(rb_class_of(self), id_layout, rest);
        (rb_obj_write((VALUE)(self), (VALUE *)(&s->rbLayout), (VALUE)(rbLayout), "Struct.c", 138));
    } else {
        (rb_obj_write((VALUE)(self), (VALUE *)(&s->rbLayout), (VALUE)(struct_class_layout(klass)), "Struct.c", 140));
    }
    if (!rb_obj_is_kind_of(s->rbLayout, rbffi_StructLayoutClass)) {
        rb_raise(rb_eRuntimeError, "Invalid Struct layout");
    }
    ((s->layout) = ((StructLayout *)rb_check_typeddata((s->rbLayout), (&rbffi_struct_layout_data_type))));
    if (rbPointer != ((VALUE)RUBY_Qnil)) {
        s->pointer = rbffi_AbstractMemory_Cast((rbPointer), &rbffi_abstract_memory_data_type);
        (rb_obj_write((VALUE)(self), (VALUE *)(&s->rbPointer), (VALUE)(rbPointer), "Struct.c", 151));
    } else {
...
struct_initialize_copy(VALUE self, VALUE other)
{
    Struct* src;
    Struct* dst;
    ((dst) = ((Struct *)rb_check_typeddata((self), (&rbffi_struct_data_type))));
    ((src) = ((Struct *)rb_check_typeddata((other), (&rbffi_struct_data_type))));
    if (dst == src) {
        return self;
    }
    (rb_obj_write((VALUE)(self), (VALUE *)(&dst->rbLayout), (VALUE)(src->rbLayout), "Struct.c", 176));
    dst->layout = src->layout;
    if (src->pointer->address != ((void *)0)) {
        (rb_obj_write((VALUE)(self), (VALUE *)(&dst->rbPointer), (VALUE)(rbffi_MemoryPointer_NewInstance(1, src->layout->size, 0)), "Struct.c", 185));
        dst->pointer = rbffi_AbstractMemory_Cast((dst->rbPointer), &rbffi_abstract_memory_data_type);
        memcpy(dst->pointer->address, src->pointer->address, src->layout->size);
    } else {
        (rb_obj_write((VALUE)(self), (VALUE *)(&dst->rbPointer), (VALUE)(src->rbPointer), "Struct.c", 189));
        dst->pointer = src->pointer;
    }
    if (src->layout->referenceFieldCount > 0) {
        size_t index;
        dst->rbReferences = ((VALUE *)ruby_xmalloc2((dst->layout->referenceFieldCount), sizeof(VALUE)));
        ...
        for ( index = 0; index < dst->layout->referenceFieldCount; index++) {
            (rb_obj_written((VALUE)(self), (VALUE)(((VALUE)RUBY_Qundef)), (VALUE)(&dst->rbReferences[index]), "Struct.c", 199));
        }
    }
    return self;
}
...
struct_layout(VALUE self)
{
    ...
    if (s->layout == ((void *)0)) {
        (rb_obj_write((VALUE)(self), (VALUE *)(&s->rbLayout), (VALUE)(struct_class_layout(rb_class_of(self))), "Struct.c", 232));
        ((s->layout) = ((StructLayout *)rb_check_typeddata((s->rbLayout), (&rbffi_struct_layout_data_type))));
    }
    return s->layout;
}
...
{
    if (s->rbPointer == ((VALUE)RUBY_Qnil)) {
        (rb_obj_write((VALUE)(self), (VALUE *)(&s->rbPointer), (VALUE)(rbffi_MemoryPointer_NewInstance(s->layout->size, 1, 1)), "Struct.c", 260));
    } else if (!rb_obj_is_kind_of(s->rbPointer, rbffi_AbstractMemoryClass)) {
        rb_raise(rb_eRuntimeError, "invalid pointer in struct");
    }
    ((s->pointer) = ((AbstractMemory *)rb_check_typeddata((s->rbPointer), (&rbffi_abstract_memory_data_type))));
}
static void
struct_mark(void *data)
{
    ...
    if (s->rbReferences != ((void *)0)) {
        size_t index;
        for (index = 0; index < s->layout->referenceFieldCount; index++) {
            rb_gc_mark(s->rbReferences[index]);
        }
    }
}
static void
...
{
    if (__builtin_expect((f->referenceIndex == -1), 0)) {
        rb_raise(rb_eRuntimeError, "put_reference_value called for non-reference type");
        return;
    }
    if (s->rbReferences == ((void *)0)) {
        int i;
        s->rbReferences = ((VALUE *)ruby_xmalloc2((s->layout->referenceFieldCount), sizeof(VALUE)));
        for (i = 0; i < s->layout->referenceFieldCount; ++i) {
            (rb_obj_write((VALUE)(self), (VALUE *)(&s->rbReferences[i]), (VALUE)(((VALUE)RUBY_Qnil)), "Struct.c", 322));
        }
    }
    (rb_obj_write((VALUE)(self), (VALUE *)(&s->rbReferences[f->referenceIndex]), (VALUE)(value), "Struct.c", 326));
}
static StructField *
struct_field(Struct* s, VALUE fieldName)
{
    StructLayout* layout = s->layout;
    struct field_cache_entry *p_ce = ( &(layout)->cache_row[((fieldName) >> 8) & 0xff] );
    if (__builtin_expect((!RB_SYMBOL_P(fieldName) || !p_ce->fieldName || p_ce->fieldName != fieldName), 0)) {
        VALUE rbField = rb_hash_aref(layout->rbFieldMap, fieldName);
        if (__builtin_expect((RB_NIL_P(rbField)), 0)) {
            VALUE str = rb_funcallv(fieldName, id_to_s, 0, ((void *)0));
            rb_raise(rb_eArgError, "No such field '%s'", rb_string_value_cstr(&(str)));
        }
        (rb_obj_write((VALUE)(s->rbLayout), (VALUE *)(&p_ce->fieldName), (VALUE)(fieldName), "Struct.c", 344));
        ((p_ce->field) = ((StructField *)rb_check_typeddata((rbField), (&rbffi_struct_field_data_type))));
    }
    return p_ce->field;
}
static VALUE
...
struct_aset(VALUE self, VALUE fieldName, VALUE value)
{
    ...
    if (f->memoryOp != ((void *)0)) {
        ...
        argv[0] = s->rbPointer;
        argv[1] = value;
        rb_funcallv(rbField, id_put, 2, argv);
    }
...
struct_set_pointer(VALUE self, VALUE pointer)
{
    ...
    ((s) = ((Struct *)rb_check_typeddata((self), (&rbffi_struct_data_type))));
    ((memory) = ((AbstractMemory *)rb_check_typeddata((pointer), (&rbffi_abstract_memory_data_type))));
    ...
    s->pointer = rbffi_AbstractMemory_Cast((pointer), &rbffi_abstract_memory_data_type);
    (rb_obj_write((VALUE)(self), (VALUE *)(&s->rbPointer), (VALUE)(pointer), "Struct.c", 443));
...
struct_set_layout(VALUE self, VALUE layout)
{
    ...
    ((s->layout) = ((StructLayout *)rb_check_typeddata((layout), (&rbffi_struct_layout_data_type))));
...
struct_null_p(VALUE self)
{
    Struct* s;
    ((s) = ((Struct *)rb_check_typeddata((self), (&rbffi_struct_data_type))));
    return s->pointer->address == ((void *)0) ? ((VALUE)RUBY_Qtrue) : ((VALUE)RUBY_Qfalse);
}
static VALUE
struct_order(int argc, VALUE* argv, VALUE self)
{
    ...
    ((s) = ((Struct *)rb_check_typeddata((self), (&rbffi_struct_data_type))));
    if (argc == 0) {
        return rb_funcall(s->rbPointer, (__builtin_constant_p("order") ? __extension__ ({ static ID rbimpl_id; rbimpl_intern_const(&rbimpl_id, ("order")); }) : (rb_intern)("order")), 0);
    } else {
        VALUE retval = rb_obj_dup(self);
        VALUE rbPointer = rb_funcallv(s->rbPointer, (__builtin_constant_p("order") ? __extension__ ({ static ID rbimpl_id; rbimpl_intern_const(&rbimpl_id, ("order")); }) : (rb_intern)("order")), argc, argv);
...
inline_array_allocate(VALUE klass)
{
    InlineArray* array;
    VALUE obj;
    obj = __extension__({ VALUE data_struct_obj = rb_data_typed_object_zalloc(klass, sizeof(InlineArray), &inline_array_data_type); (array) = (InlineArray *)RTYPEDDATA_GET_DATA(data_struct_obj); ((void)(array)); data_struct_obj; });
    (rb_obj_write((VALUE)(obj), (VALUE *)(&array->rbMemory), (VALUE)(((VALUE)RUBY_Qnil)), "Struct.c", 560));
    (rb_obj_write((VALUE)(obj), (VALUE *)(&array->rbField), (VALUE)(((VALUE)RUBY_Qnil)), "Struct.c", 561));
    return obj;
}
static void
...
{
    InlineArray* array;
    ((array) = ((InlineArray *)rb_check_typeddata((self), (&inline_array_data_type))));
    (rb_obj_write((VALUE)(self), (VALUE *)(&array->rbMemory), (VALUE)(rbMemory), "Struct.c", 601));
    (rb_obj_write((VALUE)(self), (VALUE *)(&array->rbField), (VALUE)(rbField), "Struct.c", 602));
    ((array->memory) = ((AbstractMemory *)rb_check_typeddata((rbMemory), (&rbffi_abstract_memory_data_type))));
    ((array->field) = ((StructField *)rb_check_typeddata((rbField), (&rbffi_struct_field_data_type))));
    ((array->arrayType) = ((ArrayType *)rb_check_typeddata((array->field->rbType), (&rbffi_array_type_data_type))));
    ((array->componentType) = ((Type *)rb_check_typeddata((array->arrayType->rbComponentType), (&rbffi_type_data_type))));
    array->op = get_memory_op(array->componentType);
    if (array->op == ((void *)0) && array->componentType->nativeType == NATIVE_MAPPED) {
...
inline_array_size(VALUE self)
{
    InlineArray* array;
    ((array) = ((InlineArray *)rb_check_typeddata((self), (&inline_array_data_type))));
    return rb_uint2num_inline(((ArrayType *) array->field->type)->length);
}
static int
...
inline_array_aref(VALUE self, VALUE rbIndex)
{
    ...
    if (array->op != ((void *)0)) {
        VALUE rbNativeValue = array->op->get(array->memory,
                inline_array_offset(array, rb_num2int_inline(rbIndex)));
        if (__builtin_expect((array->componentType->nativeType == NATIVE_MAPPED), 0)) {
            return rb_funcall(((MappedType *) array->componentType)->rbConverter,
                    (__builtin_constant_p("from_native") ? __extension__ ({ static ID rbimpl_id; rbimpl_intern_const(&rbimpl_id, ("from_native")); }) : (rb_intern)("from_native")), 2, rbNativeValue, ((VALUE)RUBY_Qnil));
        } else {
            return rbNativeValue;
        }
    } else if (array->componentType->nativeType == NATIVE_STRUCT) {
        VALUE rbOffset = rb_int2num_inline(inline_array_offset(array, rb_num2int_inline(rbIndex)));
        VALUE rbLength = rb_int2num_inline(array->componentType->ffiType->size);
        VALUE rbPointer = rb_funcall(array->rbMemory, (__builtin_constant_p("slice") ? __extension__ ({ static ID rbimpl_id; rbimpl_intern_const(&rbimpl_id, ("slice")); }) : (rb_intern)("slice")), 2, rbOffset, rbLength);
        VALUE obj;
    ...
    if (array->op != ((void *)0)) {
        if (__builtin_expect((array->componentType->nativeType == NATIVE_MAPPED), 0)) {
            rbValue = rb_funcall(((MappedType *) array->componentType)->rbConverter,
                    (__builtin_constant_p("to_native") ? __extension__ ({ static ID rbimpl_id; rbimpl_intern_const(&rbimpl_id, ("to_native")); }) : (rb_intern)("to_native")), 2, rbValue, ((VALUE)RUBY_Qnil));
        }
        array->op->put(array->memory, inline_array_offset(array, rb_num2int_inline(rbIndex)),
            rbValue);
    } else if (array->componentType->nativeType == NATIVE_STRUCT) {
        int offset = inline_array_offset(array, rb_num2int_inline(rbIndex));
        Struct* s;
        ...
        ((s) = ((Struct *)rb_check_typeddata((rbValue), (&rbffi_struct_data_type))));
        checkRead(s->pointer);
        ...
        ArrayType* arrayType;
        ((arrayType) = ((ArrayType *)rb_check_typeddata((array->field->rbType), (&rbffi_array_type_data_type))));
...
inline_array_each(VALUE self)
{
    ...
    for (i = 0; i < array->length; ++i) {
        rb_yield(inline_array_aref(self, __builtin_choose_expr( __builtin_constant_p(i), ((VALUE)(i)) << 1 | RUBY_FIXNUM_FLAG, RB_INT2FIX(i))));
    }
    return self;
}
static VALUE
inline_array_to_a(VALUE self)
{
    ...
    int i;
    ((array) = ((InlineArray *)rb_check_typeddata((self), (&inline_array_data_type))));
    obj = rb_ary_new_capa(array->length);
    for (i = 0; i < array->length; ++i) {
        rb_ary_push(obj, inline_array_aref(self, __builtin_choose_expr( __builtin_constant_p(i), ((VALUE)(i)) << 1 | RUBY_FIXNUM_FLAG, RB_INT2FIX(i))));
    }
    return obj;
}
static VALUE
inline_array_to_s(VALUE self)
{
    ...
    if (array->componentType->nativeType != NATIVE_INT8 && array->componentType->nativeType != NATIVE_UINT8) {
        VALUE dummy = ((VALUE)RUBY_Qnil);
        return rb_call_super(0, &dummy);
    }
    argv[0] = rb_uint2num_inline(array->field->offset);
    argv[1] = rb_uint2num_inline(array->length);
    return rb_funcallv(array->rbMemory, (__builtin_constant_p("get_string") ? __extension__ ({ static ID rbimpl_id; rbimpl_intern_const(&rbimpl_id, ("get_string")); }) : (rb_intern)("get_string")), 2, argv);
}
static VALUE
inline_array_to_ptr(VALUE self)
{
    InlineArray* array;
    ((array) = ((InlineArray *)rb_check_typeddata((self), (&inline_array_data_type))));
    return rb_funcall(array->rbMemory, (__builtin_constant_p("slice") ? __extension__ ({ static ID rbimpl_id; rbimpl_intern_const(&rbimpl_id, ("slice")); }) : (rb_intern)("slice")), 2,
        rb_uint2num_inline(array->field->offset), rb_uint2num_inline(array->arrayType->base.ffiType->size));
}
void
rbffi_Struct_Init(VALUE moduleFFI)
{
    ...
    __builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(__builtin_types_compatible_p( __typeof__((struct_initialize)), __typeof__(rb_f_notimplement))), (__builtin_types_compatible_p( __typeof__((struct_initialize)), __typeof__(rb_f_notimplement))), 0), (rb_define_method_notimpl), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 15), (((-1)) == 15), 0), (rb_define_method_15), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 14), (((-1)) == 14), 0), (rb_define_method_14), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 13), (((-1)) == 13), 0), (rb_define_method_13), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 12), (((-1)) == 12), 0), (rb_define_method_12), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 11), (((-1)) == 11), 0), (rb_define_method_11), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 10), (((-1)) == 10), 0), (rb_define_method_10), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 9), (((-1)) == 9), 0), (rb_define_method_09), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 8), (((-1)) == 8), 0), (rb_define_method_08), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 7), (((-1)) == 7), 0), (rb_define_method_07), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 6), (((-1)) == 6), 0), (rb_define_method_06), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 5), (((-1)) == 5), 0), (rb_define_method_05), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 4), (((-1)) == 4), 0), (rb_define_method_04), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 3), (((-1)) == 3), 0), (rb_define_method_03), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 2), (((-1)) == 2), 0), (rb_define_method_02), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 1), (((-1)) == 1), 0), (rb_define_method_01), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 0), (((-1)) == 0), 0), (rb_define_method_00), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == -1), (((-1)) == -1), 0), (rb_define_method_m1), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == -2), (((-1)) == -2), 0), (rb_define_method_m2), (rb_define_method_m3))))))))))))))))))))))))))))))))))))))((StructClass), ("initialize"), (struct_initialize), (-1));
    __builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(__builtin_types_compatible_p( __typeof__((struct_initialize_copy)), __typeof__(rb_f_notimplement))), (__builtin_types_compatible_p( __typeof__((struct_initialize_copy)), __typeof__(rb_f_notimplement))), 0), (rb_define_method_notimpl), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 15), (((1)) == 15), 0), (rb_define_method_15), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 14), (((1)) == 14), 0), (rb_define_method_14), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 13), (((1)) == 13), 0), (rb_define_method_13), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 12), (((1)) == 12), 0), (rb_define_method_12), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 11), (((1)) == 11), 0), (rb_define_method_11), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 10), (((1)) == 10), 0), (rb_define_method_10), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 9), (((1)) == 9), 0), (rb_define_method_09), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 8), (((1)) == 8), 0), (rb_define_method_08), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 7), (((1)) == 7), 0), (rb_define_method_07), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 6), (((1)) == 6), 0), (rb_define_method_06), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 5), (((1)) == 5), 0), (rb_define_method_05), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 4), (((1)) == 4), 0), (rb_define_method_04), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 3), (((1)) == 3), 0), (rb_define_method_03), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 2), (((1)) == 2), 0), (rb_define_method_02), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 1), (((1)) == 1), 0), (rb_define_method_01), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 0), (((1)) == 0), 0), (rb_define_method_00), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == -1), (((1)) == -1), 0), (rb_define_method_m1), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == -2), (((1)) == -2), 0), (rb_define_method_m2), (rb_define_method_m3))))))))))))))))))))))))))))))))))))))((StructClass), ("initialize_copy"), (struct_initialize_copy), (1));
    __builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(__builtin_types_compatible_p( __typeof__((struct_order)), __typeof__(rb_f_notimplement))), (__builtin_types_compatible_p( __typeof__((struct_order)), __typeof__(rb_f_notimplement))), 0), (rb_define_method_notimpl), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 15), (((-1)) == 15), 0), (rb_define_method_15), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 14), (((-1)) == 14), 0), (rb_define_method_14), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 13), (((-1)) == 13), 0), (rb_define_method_13), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 12), (((-1)) == 12), 0), (rb_define_method_12), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 11), (((-1)) == 11), 0), (rb_define_method_11), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 10), (((-1)) == 10), 0), (rb_define_method_10), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 9), (((-1)) == 9), 0), (rb_define_method_09), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 8), (((-1)) == 8), 0), (rb_define_method_08), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 7), (((-1)) == 7), 0), (rb_define_method_07), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 6), (((-1)) == 6), 0), (rb_define_method_06), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 5), (((-1)) == 5), 0), (rb_define_method_05), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 4), (((-1)) == 4), 0), (rb_define_method_04), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 3), (((-1)) == 3), 0), (rb_define_method_03), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 2), (((-1)) == 2), 0), (rb_define_method_02), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 1), (((-1)) == 1), 0), (rb_define_method_01), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == 0), (((-1)) == 0), 0), (rb_define_method_00), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == -1), (((-1)) == -1), 0), (rb_define_method_m1), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((-1)) == -2), (((-1)) == -2), 0), (rb_define_method_m2), (rb_define_method_m3))))))))))))))))))))))))))))))))))))))((StructClass), ("order"), (struct_order), (-1));
    ...
    __builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(__builtin_types_compatible_p( __typeof__((struct_get_pointer)), __typeof__(rb_f_notimplement))), (__builtin_types_compatible_p( __typeof__((struct_get_pointer)), __typeof__(rb_f_notimplement))), 0), (rb_define_method_notimpl), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 15), (((0)) == 15), 0), (rb_define_method_15), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 14), (((0)) == 14), 0), (rb_define_method_14), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 13), (((0)) == 13), 0), (rb_define_method_13), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 12), (((0)) == 12), 0), (rb_define_method_12), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 11), (((0)) == 11), 0), (rb_define_method_11), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 10), (((0)) == 10), 0), (rb_define_method_10), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 9), (((0)) == 9), 0), (rb_define_method_09), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 8), (((0)) == 8), 0), (rb_define_method_08), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 7), (((0)) == 7), 0), (rb_define_method_07), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 6), (((0)) == 6), 0), (rb_define_method_06), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 5), (((0)) == 5), 0), (rb_define_method_05), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 4), (((0)) == 4), 0), (rb_define_method_04), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 3), (((0)) == 3), 0), (rb_define_method_03), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 2), (((0)) == 2), 0), (rb_define_method_02), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 1), (((0)) == 1), 0), (rb_define_method_01), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 0), (((0)) == 0), 0), (rb_define_method_00), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == -1), (((0)) == -1), 0), (rb_define_method_m1), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == -2), (((0)) == -2), 0), (rb_define_method_m2), (rb_define_method_m3))))))))))))))))))))))))))))))))))))))((StructClass), ("pointer"), (struct_get_pointer), (0));
    __builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(__builtin_types_compatible_p( __typeof__((struct_set_pointer)), __typeof__(rb_f_notimplement))), (__builtin_types_compatible_p( __typeof__((struct_set_pointer)), __typeof__(rb_f_notimplement))), 0), (rb_define_private_method_notimpl), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 15), (((1)) == 15), 0), (rb_define_private_method_15), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 14), (((1)) == 14), 0), (rb_define_private_method_14), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 13), (((1)) == 13), 0), (rb_define_private_method_13), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 12), (((1)) == 12), 0), (rb_define_private_method_12), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 11), (((1)) == 11), 0), (rb_define_private_method_11), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 10), (((1)) == 10), 0), (rb_define_private_method_10), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 9), (((1)) == 9), 0), (rb_define_private_method_09), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 8), (((1)) == 8), 0), (rb_define_private_method_08), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 7), (((1)) == 7), 0), (rb_define_private_method_07), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 6), (((1)) == 6), 0), (rb_define_private_method_06), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 5), (((1)) == 5), 0), (rb_define_private_method_05), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 4), (((1)) == 4), 0), (rb_define_private_method_04), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 3), (((1)) == 3), 0), (rb_define_private_method_03), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 2), (((1)) == 2), 0), (rb_define_private_method_02), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 1), (((1)) == 1), 0), (rb_define_private_method_01), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 0), (((1)) == 0), 0), (rb_define_private_method_00), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == -1), (((1)) == -1), 0), (rb_define_private_method_m1), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == -2), (((1)) == -2), 0), (rb_define_private_method_m2), (rb_define_private_method_m3))))))))))))))))))))))))))))))))))))))((StructClass), ("pointer="), (struct_set_pointer), (1));
    __builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(__builtin_types_compatible_p( __typeof__((struct_get_layout)), __typeof__(rb_f_notimplement))), (__builtin_types_compatible_p( __typeof__((struct_get_layout)), __typeof__(rb_f_notimplement))), 0), (rb_define_method_notimpl), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 15), (((0)) == 15), 0), (rb_define_method_15), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 14), (((0)) == 14), 0), (rb_define_method_14), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 13), (((0)) == 13), 0), (rb_define_method_13), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 12), (((0)) == 12), 0), (rb_define_method_12), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 11), (((0)) == 11), 0), (rb_define_method_11), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 10), (((0)) == 10), 0), (rb_define_method_10), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 9), (((0)) == 9), 0), (rb_define_method_09), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 8), (((0)) == 8), 0), (rb_define_method_08), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 7), (((0)) == 7), 0), (rb_define_method_07), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 6), (((0)) == 6), 0), (rb_define_method_06), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 5), (((0)) == 5), 0), (rb_define_method_05), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 4), (((0)) == 4), 0), (rb_define_method_04), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 3), (((0)) == 3), 0), (rb_define_method_03), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 2), (((0)) == 2), 0), (rb_define_method_02), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 1), (((0)) == 1), 0), (rb_define_method_01), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 0), (((0)) == 0), 0), (rb_define_method_00), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == -1), (((0)) == -1), 0), (rb_define_method_m1), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == -2), (((0)) == -2), 0), (rb_define_method_m2), (rb_define_method_m3))))))))))))))))))))))))))))))))))))))((StructClass), ("layout"), (struct_get_layout), (0));
    __builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(__builtin_types_compatible_p( __typeof__((struct_set_layout)), __typeof__(rb_f_notimplement))), (__builtin_types_compatible_p( __typeof__((struct_set_layout)), __typeof__(rb_f_notimplement))), 0), (rb_define_private_method_notimpl), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 15), (((1)) == 15), 0), (rb_define_private_method_15), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 14), (((1)) == 14), 0), (rb_define_private_method_14), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 13), (((1)) == 13), 0), (rb_define_private_method_13), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 12), (((1)) == 12), 0), (rb_define_private_method_12), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 11), (((1)) == 11), 0), (rb_define_private_method_11), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 10), (((1)) == 10), 0), (rb_define_private_method_10), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 9), (((1)) == 9), 0), (rb_define_private_method_09), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 8), (((1)) == 8), 0), (rb_define_private_method_08), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 7), (((1)) == 7), 0), (rb_define_private_method_07), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 6), (((1)) == 6), 0), (rb_define_private_method_06), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 5), (((1)) == 5), 0), (rb_define_private_method_05), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 4), (((1)) == 4), 0), (rb_define_private_method_04), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 3), (((1)) == 3), 0), (rb_define_private_method_03), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 2), (((1)) == 2), 0), (rb_define_private_method_02), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 1), (((1)) == 1), 0), (rb_define_private_method_01), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 0), (((1)) == 0), 0), (rb_define_private_method_00), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == -1), (((1)) == -1), 0), (rb_define_private_method_m1), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == -2), (((1)) == -2), 0), (rb_define_private_method_m2), (rb_define_private_method_m3))))))))))))))))))))))))))))))))))))))((StructClass), ("layout="), (struct_set_layout), (1));
    __builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(__builtin_types_compatible_p( __typeof__((struct_aref)), __typeof__(rb_f_notimplement))), (__builtin_types_compatible_p( __typeof__((struct_aref)), __typeof__(rb_f_notimplement))), 0), (rb_define_method_notimpl), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 15), (((1)) == 15), 0), (rb_define_method_15), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 14), (((1)) == 14), 0), (rb_define_method_14), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 13), (((1)) == 13), 0), (rb_define_method_13), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 12), (((1)) == 12), 0), (rb_define_method_12), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 11), (((1)) == 11), 0), (rb_define_method_11), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 10), (((1)) == 10), 0), (rb_define_method_10), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 9), (((1)) == 9), 0), (rb_define_method_09), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 8), (((1)) == 8), 0), (rb_define_method_08), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 7), (((1)) == 7), 0), (rb_define_method_07), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 6), (((1)) == 6), 0), (rb_define_method_06), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 5), (((1)) == 5), 0), (rb_define_method_05), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 4), (((1)) == 4), 0), (rb_define_method_04), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 3), (((1)) == 3), 0), (rb_define_method_03), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 2), (((1)) == 2), 0), (rb_define_method_02), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 1), (((1)) == 1), 0), (rb_define_method_01), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 0), (((1)) == 0), 0), (rb_define_method_00), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == -1), (((1)) == -1), 0), (rb_define_method_m1), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == -2), (((1)) == -2), 0), (rb_define_method_m2), (rb_define_method_m3))))))))))))))))))))))))))))))))))))))((StructClass), ("[]"), (struct_aref), (1));
    __builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(__builtin_types_compatible_p( __typeof__((struct_aset)), __typeof__(rb_f_notimplement))), (__builtin_types_compatible_p( __typeof__((struct_aset)), __typeof__(rb_f_notimplement))), 0), (rb_define_method_notimpl), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 15), (((2)) == 15), 0), (rb_define_method_15), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 14), (((2)) == 14), 0), (rb_define_method_14), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 13), (((2)) == 13), 0), (rb_define_method_13), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 12), (((2)) == 12), 0), (rb_define_method_12), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 11), (((2)) == 11), 0), (rb_define_method_11), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 10), (((2)) == 10), 0), (rb_define_method_10), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 9), (((2)) == 9), 0), (rb_define_method_09), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 8), (((2)) == 8), 0), (rb_define_method_08), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 7), (((2)) == 7), 0), (rb_define_method_07), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 6), (((2)) == 6), 0), (rb_define_method_06), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 5), (((2)) == 5), 0), (rb_define_method_05), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 4), (((2)) == 4), 0), (rb_define_method_04), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 3), (((2)) == 3), 0), (rb_define_method_03), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 2), (((2)) == 2), 0), (rb_define_method_02), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 1), (((2)) == 1), 0), (rb_define_method_01), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 0), (((2)) == 0), 0), (rb_define_method_00), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == -1), (((2)) == -1), 0), (rb_define_method_m1), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == -2), (((2)) == -2), 0), (rb_define_method_m2), (rb_define_method_m3))))))))))))))))))))))))))))))))))))))((StructClass), ("[]="), (struct_aset), (2));
    __builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(__builtin_types_compatible_p( __typeof__((struct_null_p)), __typeof__(rb_f_notimplement))), (__builtin_types_compatible_p( __typeof__((struct_null_p)), __typeof__(rb_f_notimplement))), 0), (rb_define_method_notimpl), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 15), (((0)) == 15), 0), (rb_define_method_15), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 14), (((0)) == 14), 0), (rb_define_method_14), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 13), (((0)) == 13), 0), (rb_define_method_13), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 12), (((0)) == 12), 0), (rb_define_method_12), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 11), (((0)) == 11), 0), (rb_define_method_11), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 10), (((0)) == 10), 0), (rb_define_method_10), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 9), (((0)) == 9), 0), (rb_define_method_09), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 8), (((0)) == 8), 0), (rb_define_method_08), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 7), (((0)) == 7), 0), (rb_define_method_07), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 6), (((0)) == 6), 0), (rb_define_method_06), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 5), (((0)) == 5), 0), (rb_define_method_05), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 4), (((0)) == 4), 0), (rb_define_method_04), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 3), (((0)) == 3), 0), (rb_define_method_03), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 2), (((0)) == 2), 0), (rb_define_method_02), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 1), (((0)) == 1), 0), (rb_define_method_01), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 0), (((0)) == 0), 0), (rb_define_method_00), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == -1), (((0)) == -1), 0), (rb_define_method_m1), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == -2), (((0)) == -2), 0), (rb_define_method_m2), (rb_define_method_m3))))))))))))))))))))))))))))))))))))))((StructClass), ("null?"), (struct_null_p), (0));
    ...
    __builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(__builtin_types_compatible_p( __typeof__((inline_array_initialize)), __typeof__(rb_f_notimplement))), (__builtin_types_compatible_p( __typeof__((inline_array_initialize)), __typeof__(rb_f_notimplement))), 0), (rb_define_method_notimpl), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 15), (((2)) == 15), 0), (rb_define_method_15), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 14), (((2)) == 14), 0), (rb_define_method_14), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 13), (((2)) == 13), 0), (rb_define_method_13), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 12), (((2)) == 12), 0), (rb_define_method_12), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 11), (((2)) == 11), 0), (rb_define_method_11), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 10), (((2)) == 10), 0), (rb_define_method_10), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 9), (((2)) == 9), 0), (rb_define_method_09), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 8), (((2)) == 8), 0), (rb_define_method_08), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 7), (((2)) == 7), 0), (rb_define_method_07), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 6), (((2)) == 6), 0), (rb_define_method_06), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 5), (((2)) == 5), 0), (rb_define_method_05), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 4), (((2)) == 4), 0), (rb_define_method_04), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 3), (((2)) == 3), 0), (rb_define_method_03), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 2), (((2)) == 2), 0), (rb_define_method_02), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 1), (((2)) == 1), 0), (rb_define_method_01), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 0), (((2)) == 0), 0), (rb_define_method_00), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == -1), (((2)) == -1), 0), (rb_define_method_m1), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == -2), (((2)) == -2), 0), (rb_define_method_m2), (rb_define_method_m3))))))))))))))))))))))))))))))))))))))((rbffi_StructInlineArrayClass), ("initialize"), (inline_array_initialize), (2));
    __builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(__builtin_types_compatible_p( __typeof__((inline_array_aref)), __typeof__(rb_f_notimplement))), (__builtin_types_compatible_p( __typeof__((inline_array_aref)), __typeof__(rb_f_notimplement))), 0), (rb_define_method_notimpl), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 15), (((1)) == 15), 0), (rb_define_method_15), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 14), (((1)) == 14), 0), (rb_define_method_14), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 13), (((1)) == 13), 0), (rb_define_method_13), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 12), (((1)) == 12), 0), (rb_define_method_12), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 11), (((1)) == 11), 0), (rb_define_method_11), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 10), (((1)) == 10), 0), (rb_define_method_10), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 9), (((1)) == 9), 0), (rb_define_method_09), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 8), (((1)) == 8), 0), (rb_define_method_08), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 7), (((1)) == 7), 0), (rb_define_method_07), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 6), (((1)) == 6), 0), (rb_define_method_06), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 5), (((1)) == 5), 0), (rb_define_method_05), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 4), (((1)) == 4), 0), (rb_define_method_04), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 3), (((1)) == 3), 0), (rb_define_method_03), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 2), (((1)) == 2), 0), (rb_define_method_02), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 1), (((1)) == 1), 0), (rb_define_method_01), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == 0), (((1)) == 0), 0), (rb_define_method_00), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == -1), (((1)) == -1), 0), (rb_define_method_m1), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((1)) == -2), (((1)) == -2), 0), (rb_define_method_m2), (rb_define_method_m3))))))))))))))))))))))))))))))))))))))((rbffi_StructInlineArrayClass), ("[]"), (inline_array_aref), (1));
    __builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(__builtin_types_compatible_p( __typeof__((inline_array_aset)), __typeof__(rb_f_notimplement))), (__builtin_types_compatible_p( __typeof__((inline_array_aset)), __typeof__(rb_f_notimplement))), 0), (rb_define_method_notimpl), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 15), (((2)) == 15), 0), (rb_define_method_15), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 14), (((2)) == 14), 0), (rb_define_method_14), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 13), (((2)) == 13), 0), (rb_define_method_13), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 12), (((2)) == 12), 0), (rb_define_method_12), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 11), (((2)) == 11), 0), (rb_define_method_11), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 10), (((2)) == 10), 0), (rb_define_method_10), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 9), (((2)) == 9), 0), (rb_define_method_09), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 8), (((2)) == 8), 0), (rb_define_method_08), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 7), (((2)) == 7), 0), (rb_define_method_07), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 6), (((2)) == 6), 0), (rb_define_method_06), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 5), (((2)) == 5), 0), (rb_define_method_05), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 4), (((2)) == 4), 0), (rb_define_method_04), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 3), (((2)) == 3), 0), (rb_define_method_03), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 2), (((2)) == 2), 0), (rb_define_method_02), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 1), (((2)) == 1), 0), (rb_define_method_01), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == 0), (((2)) == 0), 0), (rb_define_method_00), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == -1), (((2)) == -1), 0), (rb_define_method_m1), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((2)) == -2), (((2)) == -2), 0), (rb_define_method_m2), (rb_define_method_m3))))))))))))))))))))))))))))))))))))))((rbffi_StructInlineArrayClass), ("[]="), (inline_array_aset), (2));
    __builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(__builtin_types_compatible_p( __typeof__((inline_array_each)), __typeof__(rb_f_notimplement))), (__builtin_types_compatible_p( __typeof__((inline_array_each)), __typeof__(rb_f_notimplement))), 0), (rb_define_method_notimpl), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 15), (((0)) == 15), 0), (rb_define_method_15), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 14), (((0)) == 14), 0), (rb_define_method_14), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 13), (((0)) == 13), 0), (rb_define_method_13), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 12), (((0)) == 12), 0), (rb_define_method_12), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 11), (((0)) == 11), 0), (rb_define_method_11), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 10), (((0)) == 10), 0), (rb_define_method_10), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 9), (((0)) == 9), 0), (rb_define_method_09), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 8), (((0)) == 8), 0), (rb_define_method_08), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 7), (((0)) == 7), 0), (rb_define_method_07), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 6), (((0)) == 6), 0), (rb_define_method_06), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 5), (((0)) == 5), 0), (rb_define_method_05), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 4), (((0)) == 4), 0), (rb_define_method_04), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 3), (((0)) == 3), 0), (rb_define_method_03), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 2), (((0)) == 2), 0), (rb_define_method_02), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 1), (((0)) == 1), 0), (rb_define_method_01), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 0), (((0)) == 0), 0), (rb_define_method_00), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == -1), (((0)) == -1), 0), (rb_define_method_m1), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == -2), (((0)) == -2), 0), (rb_define_method_m2), (rb_define_method_m3))))))))))))))))))))))))))))))))))))))((rbffi_StructInlineArrayClass), ("each"), (inline_array_each), (0));
    __builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(__builtin_types_compatible_p( __typeof__((inline_array_size)), __typeof__(rb_f_notimplement))), (__builtin_types_compatible_p( __typeof__((inline_array_size)), __typeof__(rb_f_notimplement))), 0), (rb_define_method_notimpl), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 15), (((0)) == 15), 0), (rb_define_method_15), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 14), (((0)) == 14), 0), (rb_define_method_14), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 13), (((0)) == 13), 0), (rb_define_method_13), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 12), (((0)) == 12), 0), (rb_define_method_12), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 11), (((0)) == 11), 0), (rb_define_method_11), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 10), (((0)) == 10), 0), (rb_define_method_10), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 9), (((0)) == 9), 0), (rb_define_method_09), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 8), (((0)) == 8), 0), (rb_define_method_08), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 7), (((0)) == 7), 0), (rb_define_method_07), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 6), (((0)) == 6), 0), (rb_define_method_06), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 5), (((0)) == 5), 0), (rb_define_method_05), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 4), (((0)) == 4), 0), (rb_define_method_04), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 3), (((0)) == 3), 0), (rb_define_method_03), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 2), (((0)) == 2), 0), (rb_define_method_02), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 1), (((0)) == 1), 0), (rb_define_method_01), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 0), (((0)) == 0), 0), (rb_define_method_00), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == -1), (((0)) == -1), 0), (rb_define_method_m1), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == -2), (((0)) == -2), 0), (rb_define_method_m2), (rb_define_method_m3))))))))))))))))))))))))))))))))))))))((rbffi_StructInlineArrayClass), ("size"), (inline_array_size), (0));
    __builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(__builtin_types_compatible_p( __typeof__((inline_array_to_a)), __typeof__(rb_f_notimplement))), (__builtin_types_compatible_p( __typeof__((inline_array_to_a)), __typeof__(rb_f_notimplement))), 0), (rb_define_method_notimpl), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 15), (((0)) == 15), 0), (rb_define_method_15), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 14), (((0)) == 14), 0), (rb_define_method_14), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 13), (((0)) == 13), 0), (rb_define_method_13), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 12), (((0)) == 12), 0), (rb_define_method_12), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 11), (((0)) == 11), 0), (rb_define_method_11), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 10), (((0)) == 10), 0), (rb_define_method_10), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 9), (((0)) == 9), 0), (rb_define_method_09), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 8), (((0)) == 8), 0), (rb_define_method_08), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 7), (((0)) == 7), 0), (rb_define_method_07), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 6), (((0)) == 6), 0), (rb_define_method_06), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 5), (((0)) == 5), 0), (rb_define_method_05), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 4), (((0)) == 4), 0), (rb_define_method_04), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 3), (((0)) == 3), 0), (rb_define_method_03), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 2), (((0)) == 2), 0), (rb_define_method_02), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 1), (((0)) == 1), 0), (rb_define_method_01), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 0), (((0)) == 0), 0), (rb_define_method_00), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == -1), (((0)) == -1), 0), (rb_define_method_m1), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == -2), (((0)) == -2), 0), (rb_define_method_m2), (rb_define_method_m3))))))))))))))))))))))))))))))))))))))((rbffi_StructInlineArrayClass), ("to_a"), (inline_array_to_a), (0));
    __builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(__builtin_types_compatible_p( __typeof__((inline_array_to_ptr)), __typeof__(rb_f_notimplement))), (__builtin_types_compatible_p( __typeof__((inline_array_to_ptr)), __typeof__(rb_f_notimplement))), 0), (rb_define_method_notimpl), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 15), (((0)) == 15), 0), (rb_define_method_15), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 14), (((0)) == 14), 0), (rb_define_method_14), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 13), (((0)) == 13), 0), (rb_define_method_13), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 12), (((0)) == 12), 0), (rb_define_method_12), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 11), (((0)) == 11), 0), (rb_define_method_11), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 10), (((0)) == 10), 0), (rb_define_method_10), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 9), (((0)) == 9), 0), (rb_define_method_09), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 8), (((0)) == 8), 0), (rb_define_method_08), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 7), (((0)) == 7), 0), (rb_define_method_07), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 6), (((0)) == 6), 0), (rb_define_method_06), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 5), (((0)) == 5), 0), (rb_define_method_05), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 4), (((0)) == 4), 0), (rb_define_method_04), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 3), (((0)) == 3), 0), (rb_define_method_03), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 2), (((0)) == 2), 0), (rb_define_method_02), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 1), (((0)) == 1), 0), (rb_define_method_01), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 0), (((0)) == 0), 0), (rb_define_method_00), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == -1), (((0)) == -1), 0), (rb_define_method_m1), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == -2), (((0)) == -2), 0), (rb_define_method_m2), (rb_define_method_m3))))))))))))))))))))))))))))))))))))))((rbffi_StructInlineArrayClass), ("to_ptr"), (inline_array_to_ptr), (0));
    __builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(__builtin_types_compatible_p( __typeof__((inline_array_to_s)), __typeof__(rb_f_notimplement))), (__builtin_types_compatible_p( __typeof__((inline_array_to_s)), __typeof__(rb_f_notimplement))), 0), (rb_define_method_notimpl), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 15), (((0)) == 15), 0), (rb_define_method_15), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 14), (((0)) == 14), 0), (rb_define_method_14), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 13), (((0)) == 13), 0), (rb_define_method_13), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 12), (((0)) == 12), 0), (rb_define_method_12), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 11), (((0)) == 11), 0), (rb_define_method_11), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 10), (((0)) == 10), 0), (rb_define_method_10), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 9), (((0)) == 9), 0), (rb_define_method_09), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 8), (((0)) == 8), 0), (rb_define_method_08), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 7), (((0)) == 7), 0), (rb_define_method_07), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 6), (((0)) == 6), 0), (rb_define_method_06), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 5), (((0)) == 5), 0), (rb_define_method_05), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 4), (((0)) == 4), 0), (rb_define_method_04), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 3), (((0)) == 3), 0), (rb_define_method_03), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 2), (((0)) == 2), 0), (rb_define_method_02), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 1), (((0)) == 1), 0), (rb_define_method_01), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == 0), (((0)) == 0), 0), (rb_define_method_00), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == -1), (((0)) == -1), 0), (rb_define_method_m1), (__builtin_choose_expr( __builtin_choose_expr( __builtin_constant_p(((0)) == -2), (((0)) == -2), 0), (rb_define_method_m2), (rb_define_method_m3))))))))))))))))))))))))))))))))))))))((rbffi_StructLayoutCharArrayClass), ("to_s"), (inline_array_to_s), (0));
    rb_define_alias(rbffi_StructLayoutCharArrayClass, "to_str", "to_s");
    id_pointer_ivar = (__builtin_constant_p("@pointer") ? __extension__ ({ static ID rbimpl_id; rbimpl_intern_const(&rbimpl_id, ("@pointer")); }) : (rb_intern)("@pointer"));
    id_layout_ivar = (__builtin_constant_p("@layout") ? __extension__ ({ static ID rbimpl_id; rbimpl_intern_const(&rbimpl_id, ("@layout")); }) : (rb_intern)("@layout"));
    id_layout = (__builtin_constant_p("layout") ? __extension__ ({ static ID rbimpl_id; rbimpl_intern_const(&rbimpl_id, ("layout")); }) : (rb_intern)("layout"));
    id_get = (__builtin_constant_p("get") ? __extension__ ({ static ID rbimpl_id; rbimpl_intern_const(&rbimpl_id, ("get")); }) : (rb_intern)("get"));
    id_put = (__builtin_constant_p("put") ? __extension__ ({ static ID rbimpl_id; rbimpl_intern_const(&rbimpl_id, ("put")); }) : (rb_intern)("put"));
    id_to_ptr = (__builtin_constant_p("to_ptr") ? __extension__ ({ static ID rbimpl_id; rbimpl_intern_const(&rbimpl_id, ("to_ptr")); }) : (rb_intern)("to_ptr"));
    id_to_s = (__builtin_constant_p("to_s") ? __extension__ ({ static ID rbimpl_id; rbimpl_intern_const(&rbimpl_id, ("to_s")); }) : (rb_intern)("to_s"));
    id_initialize = (__builtin_constant_p("initialize") ? __extension__ ({ static ID rbimpl_id; rbimpl_intern_const(&rbimpl_id, ("initialize")); }) : (rb_intern)("initialize"));
}
